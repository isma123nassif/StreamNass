...
// Provide window.webOS.service.request (built on PalmServiceBridge) before
// anything else loads, so stremio-video's native WebOsVideo player works.
require('./common/webOsBridge');
