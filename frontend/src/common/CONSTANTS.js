...
const DEFAULT_STREAMING_SERVER_URL = (typeof window !== 'undefined' && typeof window.__STREMIO_SERVER_URL__ === 'string' && window.__STREMIO_SERVER_URL__.length > 0) ? window.__STREMIO_SERVER_URL__ : 'http://127.0.0.1:11470/';
