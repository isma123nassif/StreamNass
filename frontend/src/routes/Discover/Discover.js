                        ...
                        discover.catalog === null ?
                            ...
                            discover.catalog.content.type === 'Err' ?
                                ...
                                discover.catalog.content.type === 'Loading' ?
                                    ...
                                    :
                                    <div ref={metasContainerRef} data-tv-focus-default className={classnames(styles['meta-items-container'], 'animation-fade-in')} onScroll={onScroll} onFocusCapture={metaItemsOnFocusCapture}>
